      ...
      >
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ color: '#6D28D9', fontSize: 24 }}>⚡ 15-minute delivery</div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ color: '#6D28D9', fontSize: 24 }}>🎯 99% accuracy</div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ color: '#6D28D9', fontSize: 24 }}>💰 1/100th the cost</div>
          </div>
        </div>
