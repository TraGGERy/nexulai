...
export default function AllReportsPage() {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        // Fetch all reports (default limit is 10, but we can increase if needed)
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <Link href="/reports" className="text-purple-600 hover:text-purple-800 flex items-center mb-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Complete list of your saved reports</p>
            </div>
            <Link 
              href="/dashboard" 
